export enum Icons {
    ...
    nacelleImg = './assets/images/Nacelle.jpg',
    miniPelleImg = './assets/images/MiniPelle.jpg',
    pelleHydrauliqueImg = './assets/images/pelleHydraulique.jpg',
    grueMobileIcon = './assets/images/grueMobileImage.png',
    nacelleIcon = './assets/images/nacelleImage.png',
    miniPelleIcon = './assets/images/miniPelleImage.png',
    pelleHydrauliqueIcon = './assets/images/pelleHydrauliqueImage.png',
